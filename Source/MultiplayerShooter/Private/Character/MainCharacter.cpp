...
void AMainCharacter::ToggleReadyPressed()
{
	ALobbyPlayerController* LobbyPlayerController = Cast<ALobbyPlayerController>(GetController());
	if (LobbyPlayerController)
	{
		LobbyPlayerController->ToggleIsReady();
	}
}
